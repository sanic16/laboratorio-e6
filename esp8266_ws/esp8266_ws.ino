...
#define USE_SSL         true
  ...
  #define WS_SERVER           "apli2-websocket-7abce11f887c.herokuapp.com"
  #define WS_PORT             443
#else
  // To run a local WebSocket Server
  #define WS_SERVER           "https://apli2-websocket-7abce11f887c.herokuapp.com/"
  #define WS_PORT             8080
#endif
...
void setup()
{
  ...
  WiFiMulti.addAP("dlink-FC29", "fuxae77754");
